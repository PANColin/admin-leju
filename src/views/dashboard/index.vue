<template>
  <div :style="{ height: initHeight }" class="dashboard_wrapper">
    <div
      id="dashboard_main"
      ref="dashboard_main"
...
import BfProgress from "@/components/BfProgress/index.vue";
// 地图数据
...
import { baseData } from "@/api/dashboard/index";
// 引入数字缓变方法
export default {
  components: {
    CanvasBg,
  ...
  async mounted() {
    const { success, data, message } = await baseData();
